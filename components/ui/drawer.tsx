...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay ref={ref} className={cn("hidden", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed top-0 right-0 z-50 flex h-screen flex-col bg-white lg:bg-white/50 !backdrop-blur-xl",
        className
      )}
      {...props}>
      {children}
